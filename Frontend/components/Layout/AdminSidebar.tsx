...
export default function AdminSidebar() {
  ...
  const menuItems = [
    ...
    { name: 'Matches', href: '/admin/matches', icon: HeartIcon },
    { name: 'Chat', href: '/chat', icon: ChatBubbleLeftRightIcon },
    { name: 'Blogs', href: '/admin/blogs', icon: DocumentTextIcon },
    { name: 'News', href: '/admin/news', icon: DocumentTextIcon },
            ...
            {!isCollapsed && (
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-lg bg-slate-900 dark:bg-white flex items-center justify-center">
                  <ShieldCheckIcon className="h-5 w-5 text-white dark:text-slate-900" />
                </div>
                <div>
                  <h2 className="text-sm font-semibold text-gray-900 dark:text-white">Admin</h2>
